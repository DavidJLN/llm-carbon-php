...
{
    public function testBuildsAFootprintWithItsThreeValues(): void
    {
        $footprint = new Footprint(0.007667, 4.6002, 0.3740);

        self::assertEqualsWithDelta(0.007667, $footprint->energyPerTokenWh, 0.0000001);
